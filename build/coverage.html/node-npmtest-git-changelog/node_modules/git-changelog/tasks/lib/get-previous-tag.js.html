...
&nbsp;
  return new Promise(function(resolve, reject){
    <span class="missing-if-branch" title="if path not taken" >I</span>if (module.options.tag) {
<span class="cstat-no" title="statement not covered" >      resolve(module.options.tag);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (module.options.tag === false) {
